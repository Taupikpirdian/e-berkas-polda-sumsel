            ...
            <div class="card-body pt-2">
                <form method="post" action="{{ route('izin-pengadilan.store') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row mb-5 container-field">
                            <div class="col-lg-4 col-sm-12 mb-4 mb-lg-0">
                                <input type="file" class="dropify" name="file-spdp" value="{{old('file-spdp')}}" data-bs-height="180"/>
                            </div>
                        </div>
                        @error('file-spdp')
                        <div class="mt-2 text-danger">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        <label class="form-label">File Surat Perintah Penyitaan </label>
                        <div class="row mb-5 container-field">
                            <div class="col-lg-4 col-sm-12 mb-4 mb-lg-0">
                                <input type="file" class="dropify" name="penyitaan" value="{{old('penggeledahan')}}" data-bs-height="180"/>
                            </div>
                        </div>
                        @error('penyitaan')
                        <div class="mt-2 text-danger">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        <label class="form-label">File Berita Acara Penyitaan </label>
                        <div class="row mb-5 container-field">
                            <div class="col-lg-4 col-sm-12 mb-4 mb-lg-0">
                                <input type="file" class="dropify" name="ba_penyitaan" value="{{old('ba_penggeledahan')}}" data-bs-height="180"/>
                            </div>
                        </div>
                        @error('ba_penyitaan')
                        <div class="mt-2 text-danger">{{ $message }}</div>
