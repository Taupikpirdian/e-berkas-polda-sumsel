<div>
    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{URL::to('/kejaksaan-negeri')}}">Kejaksaan Negeri</a></li>
                ...
                <div class="card-body pt-2">
                    <form action="#" method="post" wire:submit.prevent="addData">
                        ...
                        <div class="form-group">
                            <label class="form-label form-label-required">Nama Kejaksaan Negeri</label>
                            <input class="form-control form-control-sm mb-4" wire:model='name'
                                placeholder="Masukan Nama Kejaksaan Negeri" type="text">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-sm  mb-4" wire:model='alamat'
                                placeholder="Masukan Alamat Kejaksaan Negeri" type="text">
                            @error('alamat')
                            <div class="mt-2 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('kejaksaan-negeri.index') }}" class="btn btn-warning btn-icon text-white">
                                <span>
