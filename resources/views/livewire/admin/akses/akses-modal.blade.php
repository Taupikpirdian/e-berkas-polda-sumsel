<div>
    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <a href="{{ route('akses.create') }}" class="btn btn-primary btn-icon text-white me-2">
                        ...
                        <table class="table border-top table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap align-middle">{{ $data->satker }}</td>

                                    <td class="text-center align-middle">
                                        <div class="btn-group align-top">
                                            <a href="{{ route('akses.edit', Crypt::encrypt($data->id)) }}"
                                                class="btn btn-sm btn-primary badge"><i class="fa fa-edit"></i></a>
                                            <button class="btn btn-sm btn-primary badge" type="button"
                                                wire:click="$emit('deleteAksesModal', '{{ Crypt::encrypt($data->id) }}')"><i
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        window.livewire.on('deleteAksesModal', (params) => {
            setTimeout(function () {
                Swal.fire({
                    ...
                    if (result.value) {
                        window.livewire.emit('deleteAkses', params);
                        Swal.fire({
                            icon: "success",
                            title: 'Deleted!',
