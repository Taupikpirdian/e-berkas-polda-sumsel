<div>
    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{URL::to('/instansi')}}">Instansi</a></li>
                ...
                <div class="card-body pt-2">
                    <form action="#" method="post" wire:submit.prevent="addData">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control form-control-sm  mb-4" wire:model='name' placeholder="Masukan Nama Instansi" type="text">
                        @error('name')
                      ...
                      <div class="form-group">
                          ...
                          <a href="{{ route('instansi.index') }}" class="btn btn-warning btn-icon text-white">
                              <span>
