    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body" style="bottom: 15px">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-custom" wire:model='nik' placeholder="Masukan NIK">
                        @error('nik')
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-custom mb-2" wire:model='tersangka' placeholder="Masukan Tersangka"></textarea>
                        @error('tersangka')
                        <div class="mt-2 text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="date" class="form-custom" id="tgl_lahir" wire:model='tgl_lahir'>
                        </div>
                        @error('tgl_lahir')
                        <div class="mt-2 text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group" wire:ignore>
                        ...
                        <select class="form-control select2-show-search" wire:model='jk' id="jk" data-placeholder="Pilih Jenis Kelamin">
            ...
            <div class="modal-footer">
                ...
                <button  class="btn btn-primary" wire:click.prevent="addTersangka()">Save changes</button>
            </div>
        </div>
    </div>
</div>