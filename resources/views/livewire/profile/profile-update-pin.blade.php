    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ubah Pin</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12">
            <div class="card">
                ...
                <form action="#" method="post" wire:submit.prevent="updatePin">
                  @csrf
                  <div class="card-body">
                      ...
                      <div class="form-group">
                          <label class="form-label form-label-required">PIN Baru</label>
                          <input type="password" wire:model='pin' class="form-control">
                          @error('pin')
