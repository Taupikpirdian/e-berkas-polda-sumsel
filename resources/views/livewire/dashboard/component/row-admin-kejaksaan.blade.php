            ...
            @if ($listCard != null)
                @foreach ($listCard as $item)
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xl-2 col-6">
                        <a href="{{URL::to('/data-prapenuntutan?filter='.$item['filter'])}}" target="_blank">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header text-dark text-dark">
                <b>Jumlah Penanganan Perkara Oleh Jaksa</b>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table border text-nowrap text-md-nowrap table-bordered mg-b-0">
                        ...
                        <tbody>
                            @if (is_array($dataPenangananOlehJaksa) || is_object($dataPenangananOlehJaksa))
                                <?php $x = $dataPenangananOlehJaksa->currentPage() > 1 ? (10 * ($dataPenangananOlehJaksa->currentPage() - 1)) + 1 : 1; ?>
                                @forelse ($dataPenangananOlehJaksa as $i=>$data)
                                <tr>
        ...
        <div class="d-flex justify-content-end text-dark">
            {!! $dataPenangananOlehJaksa->appends(['penangananOlehJaksa' => $dataPenangananOlehJaksa->currentPage()])->links('livewire::bootstrap') !!}
        </div>
    </div>
</div>
