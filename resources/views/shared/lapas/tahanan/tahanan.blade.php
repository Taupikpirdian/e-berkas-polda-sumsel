<div wire:ignore class="modal fade" id="modalImportTahanan" class="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="{{ route('import-tahanan') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
